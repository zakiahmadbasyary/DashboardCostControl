import { Layers, ArrowLeft, Database, ShieldCheck } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between p-8">
      <header className="flex items-center justify-between border-b border-slate-800 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-xl">Dashboard A (Operasional)</h1>
      ...
      <main className="max-w-4xl mx-auto my-12 text-center space-y-6">
        ...
        <h2 className="text-3xl font-extrabold text-white">Placeholder Dashboard A</h2>
        <p className="text-slate-400 text-sm leading-relaxed max-w-xl mx-auto">
          Aplikasi ini telah disiapkan dalam arsitektur Monorepo (`apps/dashboard-a`) dan menggunakan Database A terpisah. Pengubahan data hanya dapat dilakukan oleh administrator yang diverifikasi melalui Admin Pusat.
        </p>
      </main>
