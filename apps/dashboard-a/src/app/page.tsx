...
import { Database, ShieldCheck, LayoutGrid, Menu, X } from "lucide-react";
...
export default function DashboardAPage() {
  ...
  const navItems = [
    ...
    { key: "dashboard_a", label: "WIP PG1", url: dashboardAUrl, active: true },
    { key: "dashboard_b", label: "HPP PG1", url: dashboardBUrl },
    { key: "dashboard_c", label: "HPP M3", url: dashboardCUrl },
  ];
    ...
    <div className="min-h-screen bg-[#F7F9F7] text-[#17231B] flex flex-col justify-between font-sans selection:bg-[#16823B] selection:text-white">
      ...
      <main className="max-w-4xl mx-auto my-12 text-center space-y-6 px-4 flex-1">
        ...
        <p className="text-[#5F6B63] text-sm leading-relaxed max-w-xl mx-auto">
          Aplikasi ini disiapkan untuk modul Operasional & Performa Produksi wilayah PG1. Menggunakan database terpisah dan mengonsumsi header lokal independen.
        </p>
      </main>
