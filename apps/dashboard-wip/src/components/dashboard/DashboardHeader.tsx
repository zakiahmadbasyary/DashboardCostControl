...
import { ShieldCheck, Menu, X, LayoutGrid } from "lucide-react";
...
export default function DashboardHeader() {
  ...
  const navItems = [
    { key: "wip", label: "WIP ACC", url: wipUrl, active: true },
    ...
    <header className="sticky top-0 z-50 bg-white border-b border-[#DDE5DF] shadow-2xs w-full">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="h-16 sm:h-18 flex items-center justify-between gap-4">
          ...
          <a href={portalUrl} className="flex items-center gap-3 shrink-0 py-1 group focus:outline-none">
            ...
            <div>
              ...
              <span className="text-[10px] sm:text-xs text-[#5F6B63] hidden md:block mt-0.5 font-medium">
                Cost Control & Data Analytics
              </span>
            </div>
          </a>

          {/* Navigation Items (Horizontal Pill Tabs) */}
          ...
          {/* Right Action: Portal & Admin Link */}
