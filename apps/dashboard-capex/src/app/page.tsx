...
import { Building2, LayoutGrid, ShieldCheck, Menu, X, Wrench } from "lucide-react";
...
export default function DashboardCapexPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F9F7] text-[#17231B] flex flex-col justify-between font-sans selection:bg-[#16823B] selection:text-white">
      {/* Dedicated Header for Dashboard Capex */}
      ...
      <main className="max-w-4xl mx-auto my-12 text-center space-y-6 px-4 flex-1">
        ...
        <h2 className="text-3xl font-extrabold text-[#17231B]">Dashboard Capex (Capital Expenditure)</h2>
        <p className="text-[#5F6B63] text-sm leading-relaxed max-w-xl mx-auto">
          Modul pengelolaan dan pengawasan pengeluaran belanja modal (Capital Expenditure) investasi & aset perusahaan.
        </p>
      </main>

      <footer className="text-center text-xs text-[#5F6B63] border-t border-[#DDE5DF] bg-white py-6">
        © 2026 GGF AgroMetric Platform — Dashboard Capex Workspace
      </footer>
    </div>
  );
}
