...
import { Landmark, LayoutGrid, ShieldCheck, Menu, X } from "lucide-react";
...
export default function DashboardCPage() {
  ...
  const navItems = [
    ...
    { key: "dashboard_c", label: "HPP M3", url: hppM3Url, active: true },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#F7F9F7] text-[#17231B] flex flex-col justify-between font-sans selection:bg-[#16823B] selection:text-white">
      {/* Dedicated Header for Dashboard HPP M3 */}
      ...
      <main className="max-w-4xl mx-auto my-12 text-center space-y-6 px-4 flex-1">
        ...
        <p className="text-[#5F6B63] text-sm leading-relaxed max-w-xl mx-auto">
          Aplikasi ini disiapkan untuk modul Audit Finansial & Laporan Eksekutif fasilitas M3. Menggunakan database terpisah dan mengonsumsi header navigasi independen.
        </p>
      </main>
